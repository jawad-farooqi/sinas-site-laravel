  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMain">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item"><a class="nav-link nav-link-vital active" href="{{ route('home') }}">Home</a></li>
        <li class="nav-item"><a class="nav-link nav-link-vital" href="{{ route('courses') }}">Courses</a></li>
        <li class="nav-item"><a class="nav-link nav-link-vital" href="{{ route('news') }}">News</a></li>
        <li class="nav-item"><a class="nav-link nav-link-vital" href="{{ route('gallery') }}">Gallery</a></li>
        <li class="nav-item"><a class="nav-link nav-link-vital" href="{{ route('admissions') }}">Admissions</a></li>
        <li class="nav-item"><a class="nav-link nav-link-vital" href="{{ route('contact') }}">Contact</a></li>
      </ul>
